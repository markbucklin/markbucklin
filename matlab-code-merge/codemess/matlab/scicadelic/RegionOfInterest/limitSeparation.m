function varargout = limitSeparation(r1, r2) % 2ms
...
% 	>> [verticalDist, horizontalDist] = limitSeparation(rp(1),rpRef);
% 	>> [topDist,botDdist,leftDist,rightDist] = limitSeparation(rp,rpRef);
%
if nargin < 2
	r2 = r1;
end
