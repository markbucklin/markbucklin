...
% MC = ignition.RigidMotionCorrector;
MC = ignition.MotionCorrector;
preSC = ignition.StatisticCollector;
postSC = ignition.StatisticCollector;

% CD = ignition.CellDetector;
