classdef (CaseInsensitiveProperties, TruncatedProperties)...
		FileWrapper < ignition.core.Object & handle
	...
	properties (SetAccess = ?ignition.core.Object, GetAccess = protected)
	end
	...
	methods (Static)
		function dataSetName = getNameFromFileSequence(fileName, fileDir)
			...
			% >> dataSetName = ignition.io.FileWrapper.getNameFromFileSequence(fileName, fileDir)
