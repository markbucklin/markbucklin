function [nextFcn, varargout] = getScicadelicPreProcessor()
...
%% Tiff Loader
TL = scicadelic.TiffStackLoader(filePath);
...
%todo
makeNode = @(id,op) struct('id',id,'class',class(op),'size',size(op))
node = makeNode('tiffloader',TL)
