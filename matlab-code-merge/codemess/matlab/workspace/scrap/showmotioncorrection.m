warning('showmotioncorrection.m being called from scrap directory: Z:\Files\MATLAB\toolbox\ignition\scrap')
%%
...
preSC = scicadelic.StatisticCollector;
postSC = scicadelic.StatisticCollector;
...
m=0;
idx = 0;
MC2 = scicadelic.MotionCorrector;
