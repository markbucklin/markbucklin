classdef (CaseInsensitiveProperties, TruncatedProperties) VideoStreamProcessor < ignition.SystemInterface
	...
	properties (SetAccess = ?ignition.SystemInterface)
		InputRange
		OutputRange		
	end
	properties (SetAccess = ?ignition.SystemInterface, Nontunable)
		InputDataType
		OutputDataType
		FrameSize
		FrameDimension = 4
	...
	properties (Nontunable, Access = ?ignition.SystemInterface, Hidden)
	...
	methods (Access = ?ignition.SystemInterface)
