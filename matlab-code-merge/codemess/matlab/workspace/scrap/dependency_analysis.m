warning('dependency_analysis.m being called from scrap directory: Z:\Files\MATLAB\toolbox\ignition\scrap')
warning('dependency_analysis.m being called from scrap directory: Z:\Files\ignition\ignition\scrap')
...
for ind = 1:length(Dependencies)    
    ...
    clear deps
    deps = matlab.codetools.requiredFilesAndProducts(Dependencies(ind).name);
    pause(0.0001);
