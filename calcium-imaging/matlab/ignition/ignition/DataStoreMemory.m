% SIMULINK.SIMULATIONDATA.DATASTOREMEMORY  creates a DataStoreMemory object.
%
...
%                       write to Values.
%
%              Values : MATLAB <a href="matlab: help timeseries"
%                       >timeseries</a> containing data store write values.
%
...
classdef DataStoreMemory < Simulink.SimulationData.BlockData
    ...
    properties (SetAccess = private, GetAccess = public)
        Scope = 'local';            % Scope of the DSM (local/global)
        DSMWriterBlockPaths = [];   % Writers to DSM
        DSMWriters = [];            % Writers for each value
