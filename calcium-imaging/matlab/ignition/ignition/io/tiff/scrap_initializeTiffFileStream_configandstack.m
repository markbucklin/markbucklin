function stack = initializeTiffFileStream(config)
...
try
	...
	% ----------------------------------------------
	%% INITIALIZE DYNAMIC VARIABLES IN TASK-STACK
	% ----------------------------------------------
	stack.NumFramesPerRead = 8;
	stack.FirstFrameIdx = 1;
	stack.LastFrameIdx = numFramesTotal;
	stack.NextFrameIdx = 0; % 1:taskCache.NumFramesPerRead;
	stack.PriorFrameIdx = 0;
	stack.StreamFinishedFlag = false;
