...
const int ncs = 4;
const int motion = 2;
const int ss = 10; // set to output so arduino isn't made a slave
...
void setup() {
  ...
  dispRegisters();
  delay(100);
  attachInterrupt(motion, UpdatePointer, FALLING);
  initComplete=9;
}
...
//==================================================================================
byte adns_read_reg(const byte reg_addr){
  adns_com_begin();
...
//==================================================================================
void adns_write_reg(const byte reg_addr, const byte data){
  adns_com_begin();
