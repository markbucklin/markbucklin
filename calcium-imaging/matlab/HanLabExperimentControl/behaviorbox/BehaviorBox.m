classdef BehaviorBox < hgsetget
    ...
    methods % Initialization
        function obj = BehaviorBox(varargin)
        ...
        function setup(obj)
            ...
            obj.dataSummaryObj = DataSummary(obj);
            % Ready
            obj.isready = true;            
        end
    end
    methods % User Control Functions
        ...
        function stop(obj)
            ...
            % Reset Data Summary Object (Save Previous)
            obj.dataSummaryObj.newExperiment();
        end
    end
