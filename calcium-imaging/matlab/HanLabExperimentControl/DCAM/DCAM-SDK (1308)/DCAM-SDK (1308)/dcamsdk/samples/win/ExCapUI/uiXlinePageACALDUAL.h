//#if !defined(AFX_UIXLINEPAGEACALDUAL_H__8F077043_11FB_4414_9734_DAA17672B5D5__INCLUDED_)
//#define AFX_UIXLINEPAGEACALDUAL_H__8F077043_11FB_4414_9734_DAA17672B5D5__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// uiXlinePageACALDUAL.h : header file
//

#define		TapCalibMethod				0
#define		TapCalibDataMemory			1
#define		TapCalibGain				2
#define		TapCalibBaseDataMemory_ch1	3
#define		TapCalibBaseDataMemory_ch2	4
...
/////////////////////////////////////////////////////////////////////////////
// CuiXlinePageACALDUAL dialog

class CuiXlinePageACALDUAL : public CExCapUIPropertyPage
{
	DECLARE_DYNCREATE(CuiXlinePageACALDUAL)

// Construction
public:
	CuiXlinePageACALDUAL();
	~CuiXlinePageACALDUAL();

// Dialog Data
	//{{AFX_DATA(CuiXlinePageACALDUAL)
	enum { IDD = IDD_XLINE_ACALDUAL };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CuiXlinePageACALDUAL)
	public:
	virtual void OnOK();
...
protected:
	...
	afx_msg void OnSelendokXlscAcalTapcalibbasedatamemoryCombo1();
	afx_msg void OnSelendokXlscAcalTapcalibbasedatamemoryCombo2();
...
//#endif // !defined(AFX_UIXLINEPAGEACALDUAL_H__8F077043_11FB_4414_9734_DAA17672B5D5__INCLUDED_)
