// uiPropvalue.cpp : implementation file
//
...
CuiPropvalue::CuiPropvalue(CWnd* pParent, UINT idEdit )
	: CDialog(CuiPropvalue::IDD, pParent)
{
	//{{AFX_DATA_INIT(CuiPropvalue)
	m_strValue = _T("");
	m_strMax = _T("");
	m_strMin = _T("");
	//}}AFX_DATA_INIT
...
void CuiPropvalue::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CuiPropvalue)
...
BEGIN_MESSAGE_MAP(CuiPropvalue, CDialog)
	//{{AFX_MSG_MAP(CuiPropvalue)
	ON_WM_VSCROLL()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CuiPropvalue::setvalue( double value, double valuemax, double valuemin, double valuestep )
{
	m_value		= value;
	m_valuemax	= valuemax;
	m_valuemin	= valuemin;
...
double CuiPropvalue::getvalue() const
{
	LPTSTR	endptr;
#ifdef _UNICODE
...
/////////////////////////////////////////////////////////////////////////////
// CuiPropvalue message handlers


BOOL CuiPropvalue::OnInitDialog() 
{
...
void CuiPropvalue::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
