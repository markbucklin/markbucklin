//#if !defined(AFX_UIXLINEPAGECOND_H__8F077043_11FB_4414_9734_DAA17672B5D5__INCLUDED_)
//#define AFX_UIXLINEPAGECOND_H__8F077043_11FB_4414_9734_DAA17672B5D5__INCLUDED_
...
#define		DigitalBinningMethod	10		// mode
#define		DigitalBinning			11		// mode

#include "ExCapUIPropertyPage.h"

/////////////////////////////////////////////////////////////////////////////
// CuiXlinePageCOND dialog

class CuiXlinePageCOND : public CExCapUIPropertyPage
{
	DECLARE_DYNCREATE(CuiXlinePageCOND)
...
// Dialog Data
	//{{AFX_DATA(CuiXlinePageCOND)
	enum { IDD = IDD_XLINE_COND };
	int		m_radio_trigger;
	int		m_radio_input;
	//}}AFX_DATA
...
protected:
	...
	afx_msg void OnXlscCondDigitalbinningCheck();
	afx_msg void OnSelendokXlscCondTriggerenableactiveCombo();
	afx_msg void OnSelendokXlscCondDigitalbinningCombo();
...
//#endif // !defined(AFX_UIXLINEPAGECOND_H__8F077043_11FB_4414_9734_DAA17672B5D5__INCLUDED_)
