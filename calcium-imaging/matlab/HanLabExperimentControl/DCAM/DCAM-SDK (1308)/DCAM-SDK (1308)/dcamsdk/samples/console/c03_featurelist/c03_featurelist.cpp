...
//
//
// Sample program to show the list of all FEATUREs and set/get values.
...
BOOL dcamcon_getfeatureinq( HDCAM hdcam, _DWORD featureid, DCAM_PARAM_FEATURE_INQ& inq );
BOOL dcamcon_getfeature( HDCAM hdcam, _DWORD featureid, double& value, _DWORD& flags );
void dcamcon_show_featureinq( const DCAM_PARAM_FEATURE_INQ& inq, double value, _DWORD flags );
BOOL dcamcon_setgetfeature( HDCAM hdcam, _DWORD featureid, double& value );
...
const char* getfeaturetext( _DWORD featureid )
{
	int	i;
