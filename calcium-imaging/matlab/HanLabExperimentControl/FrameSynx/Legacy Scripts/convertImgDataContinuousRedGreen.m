...
%
function convertImgDataContinuousRedGreen(fileName,from,to,params)
...
case 0 % mat format
	...
	if curFrame==1	    
	    ...
	    nFramesLEDTotal(:) = floor(nFramesTotal/2);
	    nFramesLEDTotal(LED) = nFramesLEDTotal(LED) + mod(nFramesTotal,2);
