function results = ecc(image, template, levels, noi, transform, delta_p_init)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
image = double(image);
temp = zeros(size(template));%ADDED BY MARK BUCKLIN 6/8/2010
...
%         disp(['Level: ' num2str(nol) ', Iteration: ' num2str(i)])
        ...
        str='cubic'; % bilinear interpolation
