...
%DOC - a wrapper for the built-in doc command to make it work on R2007a
%
...
%   and if not found calls the built-in "doc" function to scan the built-in
%   help files. This is needed because the "doc" command in R2007a no
%   longer searches the MATLAB path for help files (it did for R14 up to
%   R2006b). Once this is fixed this hack should be removed.

%  Copyright 2007 The MathWorks Ltd.
%  $Revision: 65 $    $Date: 2009-12-14 11:09:25 +0000 (Mon, 14 Dec 2009) $
