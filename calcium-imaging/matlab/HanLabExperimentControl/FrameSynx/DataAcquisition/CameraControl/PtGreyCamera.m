classdef PtGreyCamera < MatlabCompatibleCamera
  % ------------------------------------------------------------------------------
  % DcamCamera
  % FrameSynx toolbox
  % 1/8/2009
  ...
  methods % Constructor & Destructor
	 function obj = PtGreyCamera(varargin)
		if nargin > 1
		  for k = 1:2:length(varargin)
			 obj.(varargin{k}) = varargin{k+1};
		  end
		end
		obj.default = PtGreyCameraDefault; %subclass of DefaultFile class
	 end
	 function delete(obj)
		try
