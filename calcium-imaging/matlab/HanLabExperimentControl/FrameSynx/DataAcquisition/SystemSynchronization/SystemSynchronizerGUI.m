classdef SystemSynchronizerGUI < hgsetget & dynamicprops
	...
	methods % SETUP
		function obj = SystemSynchronizerGUI(mainobj)
			dbstop if error
			obj.mainObj = mainobj;
			obj.makeFigure();
			obj.makeListeners();
		...
		function makeFigure(obj)
			% Make Figure
			obj.mainFig = figure(...
				'position',[200 200 300 400],...
				'menubar','none',...
				'name','Image Acquisition System-Synchronizer',...
				'numbertitle','off',...
				'tag','mainfig',...
