...
% screenSize = get(0,'screensize'); %MB
...
% vr.window.WindowState = System.Windows.Forms.FormWindowState.Normal; %MB
vr.window.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
% vr.window.TopMost = true;
% vr.window.TopMost = false;%MB
...
vr.window.SetDesktopBounds(...
	...
	vr.screen.size(1),...
	vr.screen.size(2));
vr.window.WindowState = System.Windows.Forms.FormWindowState.Maximized;%MB
