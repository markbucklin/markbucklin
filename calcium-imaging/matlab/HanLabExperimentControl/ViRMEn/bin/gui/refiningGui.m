...
handles.showTriangulation = varargin{3};
...
set(handles.slider_verticalGrid,'min',handles.minGrid,'max',handles.maxGrid,'sliderstep',[1 2]/(handles.maxGrid-handles.minGrid));
set(handles.slider_horizontalGrid,'min',handles.minGrid,'max',handles.maxGrid,'sliderstep',[1 2]/(handles.maxGrid-handles.minGrid));
