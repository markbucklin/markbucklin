...
lowPassLength = 12;             % changed from 60 to 30 on 1/19/2014
omegascale = .6/lowPassLength; % changed from .3
xscale = 1.1/lowPassLength; % changed from .25
yscale = 1.1/lowPassLength; %previously .9
