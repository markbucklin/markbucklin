...
%  -> copied over to differentialmomentgenerator
...
if updateFineGrain
	...
	[dM1,dM2,dM3,dM4] = arrayfun(@chunkedUpdateKernelFcn, F, fM1, fM2, fM3, N);
...
% ##################################################
	...
	function [dm1,dm2,dm3,dm4] = chunkedUpdateKernelFcn(f, m1, m2, m3, na)
