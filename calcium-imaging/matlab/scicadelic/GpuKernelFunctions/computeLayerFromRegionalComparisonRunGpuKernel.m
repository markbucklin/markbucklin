function [R, varargout] = computeLayerFromRegionalComparisonRunGpuKernel(F, regDiffThreshold, radialIdx, backgroundInput, rowSubs, colSubs, frameSubs)
...
% use: parallel.gpu.rng(0, 'Philox4x32-10')
