function findAndReplaceAcrossFiles()
...
fs = rtsci.util.getNestedFiles(projectDirectory);
...
%
% function varargout = findAndReplaceAcrossFiles()
%
% if isdir('Z:\Files')
% 	startdir = 'Z:\Files';
% else
...
% 		dirnum = dirnum + 1;
% 		directories{dirnum} = subdirfcn(subDirectory);
% 	end
% 	if repeatmode
% 		str = inputdlg({'Find','Replace With'});
% 	else
