classdef (CaseInsensitiveProperties, TruncatedProperties)  BufferedTiffStackLoader <  rtsci.System ...
	...
	methods (Access = protected)
		...
		function varargout = stepImpl(obj)
			...
			if (obj.UseParallel) && (~obj.ParallelPoolObj.Connected)
	...
	methods (Hidden)
		function initialize(obj)
			...
			if isempty(obj.NumBufferBlocks)
				obj.NumBufferBlocks = ceil(obj.ParallelPoolObj.NumWorkers/2);
			end
