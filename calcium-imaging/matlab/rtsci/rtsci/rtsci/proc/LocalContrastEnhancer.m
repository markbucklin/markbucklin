classdef (CaseInsensitiveProperties = true) LocalContrastEnhancer < rtsci.System
	...
	% PRIVATE VARIABLES
	properties (SetAccess = ?rtsci.System, Nontunable, Hidden) % new-nontunable, old-hidden
