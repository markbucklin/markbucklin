classdef  (CaseInsensitiveProperties = true) MotionCorrector <  rtsci.System
	...
	methods (Access = protected)
		function setupImpl(obj,data,~)
			...
			% 			obj.FixedFrameStatCollector = rtsci.StatisticCollector;
			% 			obj.CorrCoeffStatCollector = rtsci.StatisticCollector;
			setPrivateProps(obj)
