...
%		>> var = ign.util.accessNamedCacheVariable(cacheName, variableName)
%		>> ign.util.accessNamedCacheVariable(cacheName, variableName, variableValue)
%		>> ign.util.accessNamedCacheVariable(cacheName) % reset
